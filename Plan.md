...
При новом градиентом спуске использовать дерево отрезков для поиска из n сэмплов сначала лучшего, потом из всех ворот, содержащих его, имеющих максимального лучшего и т.д. использовать логарифмическое пространство и n шагов только на первых стадиях? — нет, так как важно изучить проблему затухающих градиентов. Иметь облегчённую версию, использующуюся внутри другого алгоритма
